<?php
	...
	*/
	...
	function getThumbnailSpecs($tableName, $fieldName, $view){
		...
		elseif($tableName=='medical_records' && $fieldName=='image_1' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='medical_records' && $fieldName=='image_1' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		elseif($tableName=='medical_records' && $fieldName=='image_2' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='medical_records' && $fieldName=='image_2' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		elseif($tableName=='medical_records' && $fieldName=='image_3' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='medical_records' && $fieldName=='image_3' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		elseif($tableName=='medical_records' && $fieldName=='image_4' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='medical_records' && $fieldName=='image_4' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		elseif($tableName=='medical_records' && $fieldName=='image_5' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='medical_records' && $fieldName=='image_5' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		return FALSE;
	}
	########################################################################
	...
	function logOutUser(){
		...
		if(isset($_COOKIE['online_clinic_management_system_rememberMe'])){
			setcookie('online_clinic_management_system_rememberMe', '', time()-42000);
		}
		session_destroy();
	}
	########################################################################
